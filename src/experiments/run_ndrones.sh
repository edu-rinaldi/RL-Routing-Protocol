...
for nd in "5" "10" "15";
do
    for alg in "GEO" "RND" "ENT" "EPB" "GNT" "GPB";
    do 
...
python3 -m src.experiments.json_and_plot -nd 5 -nd 10 -nd 15 -i_s 1 -e_s 3 -exp_suffix GEO -exp_suffix RND -exp_suffix ENT -exp_suffix EPB -exp_suffix GNT -exp_suffix GPB
